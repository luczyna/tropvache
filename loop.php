...
<?php /* How to display posts in the project category */ ?>

	<?php elseif ( in_category('Sketching') ) : ?>
	jsdfhkjsdhfksjdfhk
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<?php /* is this a post or a project */ ?>
		<?php if ('project' == get_post_type()) : ?>
		<div id="post-<?php the_ID(); ?>" class="eine-project">
			<?php //image collection
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
			...
			<div class="list-content">
				...
				<p class="posted-on"><?php boilerplate_posted_on(); ?></p>
			</div>
		</article>

		<?php comments_template( '', true ); ?>
		<?php endif; //this was to see if it was a post of project ?>
